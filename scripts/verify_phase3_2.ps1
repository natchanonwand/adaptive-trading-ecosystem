...
& uv run --locked --extra discovery pytest -q -p no:cacheprovider --junitxml=test-results/phase3_2.xml
if ($LASTEXITCODE -ne 0) { throw 'Tests failed' }
# The full suite above includes tests/benchmarks/test_scope.py and prior safety checks.
...
Write-Output 'PASS: Phase 3.2 registry, prior-phase tests, fresh PostgreSQL and scope/safety checks'
